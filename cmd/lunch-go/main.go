...
func main() {
	...
	restaurants = append(restaurants, r.NewPadowetzRestaurant("https://www.menicka.cz/2743-restaurant-padowetz.html", "Padowetz", 2))
	...
	restaurants = append(restaurants, r.NewMenickaRestaurant("https://www.menicka.cz/3178-charlie-square.html", "Charlie Square", 8))
	...
	restaurants = append(restaurants, r.NewMenickaRestaurant("https://www.menicka.cz/2687-kometa-arena-pub.html", "Kometa Arena Pub", 10))
	restaurants = append(restaurants, r.NewMenickaRestaurant("https://www.menicka.cz/3160-restaurace-na-tahu-.html", "Na-tahu", 11))
	restaurants = append(restaurants, r.NewMenickaRestaurant("https://www.menicka.cz/4116-padagali.html", "Padagali", 12))
